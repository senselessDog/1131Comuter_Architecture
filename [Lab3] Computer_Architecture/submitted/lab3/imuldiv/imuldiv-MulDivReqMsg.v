...
//Quest: 加入MULU 跟 MULSU
//MODIFY: 加入MULU和MULSU的function codes(在原本的enum之後)
...
(
  ...
  // Short names
  //MODIFY: 在MulDivReqMsgToStr模組中加入新的case條件
  ...
  localparam mulu  = `IMULDIV_MULDIVREQ_MSG_FUNC_MULU;  // 在其他localparam後面加入
  localparam mulsu = `IMULDIV_MULDIVREQ_MSG_FUNC_MULSU;
  ...
  always @(*) begin
    ...
    if ( msg === `IMULDIV_MULDIVREQ_MSG_SZ'bx )
      ...
      //MODIFY: 在full_str的case statement中加入新條件
      case ( func )
        ...
        mulu    : $sformat( full_str, "mulu %d, %d", a, b );
        mulsu   : $sformat( full_str, "mulsu %d, %d", a, b );
  ...
  always @(*) begin
    ...
    if ( msg === `IMULDIV_MULDIVREQ_MSG_SZ'bx )
      ...
      //MODIFY: 在tiny_str的case statement中加入新條件
      case ( func )
        ...
        mulu    : $sformat( tiny_str, "*u"  );
        mulsu   : $sformat( tiny_str, "*s"  );
